  ...
  <div class="layoutcenter">
    ...
    <div class="mb-8">
      ...
      <div class="grid sm:grid-cols-2 grid-cols-1">
        ...
        >
          <p>
            <b class="font-black">MaiKubu</b> terdiri dari dua kata "Mai" dan
            "Kubu". Dua kata ini kami ambil dari kalimat yang sering kami
            utarakan ketika ingin mengajak teman untuk pulang. Melalui nama ini
            kami ingin berpesan untuk selalu ingat kepada tanah kelahiran.
          </p>
        </div>
      </div>
